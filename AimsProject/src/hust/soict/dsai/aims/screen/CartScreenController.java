...
public class CartScreenController {
    ...
    private void initialize() {
        ...
        tblMedia.setPlaceholder(new Label("Dong - 5608 - No item in cart"));
    ...
    void createPopUp() {
        ...
        popupwindow.setTitle("Dong - 5608 - Place order");

        Label label1 = new Label("Dong - 5608 - You have place your order !");
        label1.setFont(Font.font("Arial", FontWeight.BOLD,14));
        Label label2 = new Label("Dong - 5608 - Your bill total is " + Float.toString(cart.totalCost()) + "$");
        Button button1= new Button("Dong - 5608 - OK !");
        label2.setTextFill(Color.RED);
        button1.setOnAction(event -> popupwindow.close());
