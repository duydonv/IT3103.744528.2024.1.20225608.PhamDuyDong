...
public class AddCDStoreScreen extends AddItemToStoreScreen {
    ...
    protected void addItemToStore() {
        try {
            ...
            store.addMedia(cd);
            JOptionPane.showMessageDialog(this, "Dong - 5608 - CD added successfully!");
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Dong - 5608 - Invalid input! Please check your fields.");
        }
    }
}
