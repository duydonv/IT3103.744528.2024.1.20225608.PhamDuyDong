...
public class Store {
    ...
    public void addMedia(Media media) {
        if (itemsInStore.contains(media)) {
            System.out.println("Pham Duy Dong - 5608 - Media \"" + media.getTitle() + "\" is already in the store.");
        } else {
            itemsInStore.add(media);
            System.out.println("Pham Duy Dong - 5608 - Media \"" + media.getTitle() + "\" has been added to the store.");
        }
    }
    ...
    public void removeMedia(Media media) {
        if (itemsInStore.contains(media)) {
            ...
            System.out.println("Pham Duy Dong - 5608 - Media \"" + media.getTitle() + "\" has been removed from the store.");
        } else {
            System.out.println("Pham Duy Dong - 5608 - Media \"" + media.getTitle() + "\" was not found in the store.");
        }
    }
