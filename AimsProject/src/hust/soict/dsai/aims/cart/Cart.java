...
public class Cart {
    ...
    public void addMedia(Media media) {
        if (itemsOrdered.size() >= MAX_NUMBERS_ORDERED) {
            ...
            System.out.println("Pham Duy Dong - 5608 - The media has been added to the cart.");
        }
    }
    ...
    public void removeMedia(Media media) {
        if (itemsOrdered.contains(media)) {
            ...
            System.out.println("Pham Duy Dong - 5608 - The media has been removed from the cart.");
        } else {
            System.out.println("Pham Duy Dong - 5608 - The media was not found in the cart.");
        }
    }
